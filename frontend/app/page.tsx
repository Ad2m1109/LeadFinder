                      ...
                      <td className="px-6 py-4">
                        {lead.website ? (
                          <div className="flex flex-col gap-2">
                            ...
                            {lead.screenshot && (
                              <a href={lead.screenshot.startsWith("data:") ? lead.screenshot : `${API_BASE}${lead.screenshot}`} target="_blank" rel="noopener noreferrer" className="block w-[100px] h-[56px] rounded border border-zinc-800 overflow-hidden hover:border-indigo-500 transition relative group bg-zinc-900">
                                <img src={lead.screenshot.startsWith("data:") ? lead.screenshot : `${API_BASE}${lead.screenshot}`} alt="Website Preview" className="w-full h-full object-cover object-top opacity-80 group-hover:opacity-100 transition" />
